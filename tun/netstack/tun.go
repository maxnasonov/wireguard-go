...
import (
	...
	"github.com/maxnasonov/gvisor/pkg/tcpip/adapters/gonet"
	...
	"github.com/maxnasonov/gvisor/pkg/tcpip/transport/icmp"
	"github.com/maxnasonov/gvisor/pkg/tcpip/transport/tcp"
	"github.com/maxnasonov/gvisor/pkg/tcpip/transport/udp"
...
func (tun *netTun) Read(buf [][]byte, sizes []int, offset int) (int, error) {
	fmt.Println("reading TUN")
	view, ok := <-tun.incomingPacket
	fmt.Println("received packet in TUN")
	if !ok {
		return 0, os.ErrClosed
	}

	fmt.Println("reading packet from TUN")
